...
import type { IDocument, IInvOverload } from '@/Interfaces/invertors.js'
...
async function loadData() {
  data.value = await useFetch('/data/Inv_type_of_overload')
}
  ...
  <div v-else>
    <div class="grid">
      ...
      <div class="col-2 flex justify-content-end flex-wrap">
        <RouterLink :to="`/invertors/InvOverloads/Create/`" rel="noopener">
      ...
      <Column header="Действия">
        <template #body="slotProps">
          <div class="flex gap-2">
            <RouterLink :to="`/invertors/InvOverloads/Update/${slotProps.data.id}`">
              <Button icon="pi pi-pencil" severity="info" />
            </RouterLink>
            <RouterLink :to="`/invertors/InvOverloads/Delete/${slotProps.data.id}`">
