  ...
  <div v-else>
    <div class="grid">
      ...
      <div class="col-2 flex justify-content-end flex-wrap">
        <RouterLink :to="`/invertors/InvTypeOfControls/Create/`" rel="noopener">
      ...
      <Column header="Действия">
        <template #body="slotProps">
          <div class="flex gap-2">
            <RouterLink :to="`/invertors/InvTypeOfControls/Update/${slotProps.data.id}`">
              <Button icon="pi pi-pencil" severity="info" />
            </RouterLink>
            <RouterLink :to="`/invertors/InvTypeOfControls/Delete/${slotProps.data.id}`">
