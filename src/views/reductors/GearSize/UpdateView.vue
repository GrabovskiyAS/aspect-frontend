...
const submission = async () => {
  ...
  updateDataReductors(`/data/RedGearTypes/${props.id}`, data.value.data[0])
    .then(() => {
...
<template>
  ...
  <h1 class="pt-5">RedGearSize. Редактирование</h1>
  ...
  <div v-else class="pt-5">
    ...
    <div class="field pt-5">
      <FloatLabel>
        <InputText id="code_size_manuf" v-model="data.data[0].code_size_manuf" class="w-full" />
